...
ApprovalResultsModel approvalResultsModelFromJson(String str) =>
    ApprovalResultsModel.fromJson(json.decode(str));

String approvalResultsModelToJson(ApprovalResultsModel data) =>
...
class ApprovalResultsModel {
  ...
  factory ApprovalResultsModel.fromJson(Map<String, dynamic> json) =>
      ApprovalResultsModel(
        status: json["status"],
