...
class Form05sDone11 extends StatefulWidget {
  const Form05sDone11({Key? key}) : super(key: key);

  @override
  _Form05sDone11State createState() => _Form05sDone11State();
}

class _Form05sDone11State extends State<Form05sDone11> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Mysutitle(
                text: 'เอกสารแจ้งความจำนงขอรับ ดำเนินการแล้ว',
                vertical: 5,
              ),
              MyCarddoc(
                no: '1',
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child:
              Text('ผู้ขอรับ', style: Theme.of(context).textTheme.subtitle),
            ),
            Container(
              width: MediaQuery.of(context).size.width,
              child: Text('$nameuser',
